    ...
    <header className="jusp-header" onMouseEnter={cancelHoverClose} onMouseLeave={scheduleHoverClose}>
      <div className="jusp-header-inner">
        ...
        <div className="jusp-actions">
          ...
          {/* ✅ Carrito: abre el drawer (no navega) + badge + bump */}
          <button
            type="button"
        ...
        <div className="jusp-sheet-wrap" role="dialog" aria-modal="true">
          ...
          <div className="jusp-sheet" ref={sheetRef}>
            ...
            <div className="jusp-sheet-actions">
              ...
              {/* ✅ En móvil: también abrimos el drawer */}
              <button
                type="button"
      ...
      <style jsx global>{`:root{--jusp-header-h:64px;}
        ...
        /* ✅ Asegurar cuenta NO azul */
        .jusp-account-ico{
          color: #111 !important;
        }
        /* ✅ Cuando cuenta está activa: marca verde premium */
        .jusp-account-ico.active{
          border-color: rgba(34, 197, 94, 0.55) !important;
          box-shadow: 0 0 0 3px rgba(34, 197, 94, 0.18);
        }
        .jusp-account-ico:focus { outline: none; }
        .jusp-account-ico:focus-visible{
        ...
        /* ✅ Animación premium entrada mega */
        ...
        /* ✅ Animación premium entrada search panel */
        .jusp-search-panel {
          position: relative;
          z-index: 2;
          background: #fff;
        ...
        .jusp-sheet-wrap { position: fixed; inset: 0; z-index: 90; }
        /* ✅ FONDO BLANCO para que sea visible (no se ve el hero detrás) */
        .jusp-sheet-backdrop {
          position: absolute;
          inset: 0;
        ...
        .jusp-sheet-title { font-weight: 900; }
        ...
        .jusp-sheet-link { padding: 10px 12px; border-radius: 14px; text-decoration: none; color: #111; border: 1px solid rgba(0, 0, 0, 0.08); background:#fff; }
        .jusp-sheet-actions { margin-top: 12px; display: flex; gap: 12px; justify-content: space-between; flex-wrap: wrap; align-items: center; }
        .jusp-sheet-actions a { text-decoration: none; color: #111; font-weight: 800; }
        .jusp-sheet-cartbtn{
          border:0;
          background:transparent;
          font-weight: 900;
        ...
        .jusp-sheet-footnote { margin-top: 12px; font-size: 12px; opacity: 0.7; text-align: center; }
